			...
			<div className="kv_navigation_wrapper">
				<div className="mainmenu d-xl-block d-lg-block d-md-none d-sm-none d-none">
					<ul className="main_nav_ul">
						<li className="has-mega gc_main_navigation"><a href="/" className="gc_main_navigation hover_color">  Home </a>
							{/* <ul>
						...
						<li className="has-mega gc_main_navigation"><a href="/blog_category" className="gc_main_navigation hover_color">  Blog</a>
							{/* <ul>
						...
						{/* <!-- mega menu start --> */}
						<li className="has-mega gc_main_navigation"><a href="/gallery2" className="gc_main_navigation hover_color">  Gallery</a>
							{/* <ul>
				...
				<div className="cd-dropdown-wrapper">
					...
					<nav className="cd-dropdown">
						...
						<ul className="cd-dropdown-content">
							...
							{/* <!-- .has-children --> */}
							<li className="has-children">	<a href="/blog_category">Blog</a>
								{/* <ul className="cd-secondary-dropdown icon_menu is-hidden">
									<li className="go-back"><a href="#0">Menu</a>
									</li>
							...
							<li className="has-children">	<a href="/gallery2">Gallery</a>
								{/* <ul className="cd-secondary-dropdown icon_menu is-hidden">
									<li className="go-back"><a href="#0">Menu</a>
									</li>
